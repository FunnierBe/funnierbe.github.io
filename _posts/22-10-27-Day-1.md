...
* [choose](https://github.com/theryangeary/choose) ... human-friendly and fast, ie written in [Rust](https://www.rust-lang.org/learn/get-started), alternative to [cut](https://en.wikipedia.org/wiki/Cut_(Unix)) and (sometimes) awk [Rust](https://www.rust-lang.org/learn/get-started)
* [jq], 
* [sd], 

...
> Use the [curated list of AWESOME Bash scripts and resources.](https://github.com/awesome-lists/awesome-bash)

*Inspired by the larger [awesome](https://github.com/sindresorhus/awesome) list thing.*
